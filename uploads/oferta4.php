...
<head>
    <meta charset="UTF-8">
    <title>Apartament Business Iași</title>
...
<div class="oferta-container">
    <h2>Apartament Business Iași</h2>
    <p class="text-muted">Ideal pentru călătorii de afaceri, cu acces rapid la centrele comerciale.</p>

    <div class="oferta-images">
        <img src="../public/img/oferta4/img1.jpg" alt="Living business">
        <img src="../public/img/oferta4/img2.jpg" alt="Birou modern">
        <img src="../public/img/oferta4/img3.jpg" alt="Acces central">
    </div>

    <div class="map-container">
        <iframe src="https://www.google.com/maps?q=Palas%20Iași&output=embed" allowfullscreen="" loading="lazy"></iframe>
    </div>
</div>
