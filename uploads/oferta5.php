...
<head>
    <meta charset="UTF-8">
    <title>Luxury Loft Brașov</title>
...
<div class="oferta-container">
    <h2>Luxury Loft Brașov</h2>
    <p class="text-muted">Loft cu vedere panoramică spre munți, design premium și intimitate totală.</p>

    <div class="oferta-images">
        <img src="../public/img/oferta5/img1.jpg" alt="Vedere spre munte">
        <img src="../public/img/oferta5/img2.jpg" alt="Living spațios">
        <img src="../public/img/oferta5/img3.jpg" alt="Dormitor modern">
    </div>

    <div class="map-container">
        <iframe src="https://www.google.com/maps?q=Brașov%20Centru&output=embed" allowfullscreen="" loading="lazy"></iframe>
    </div>
</div>
