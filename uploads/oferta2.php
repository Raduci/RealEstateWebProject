...
<head>
    <meta charset="UTF-8">
    <title>Apartament 2 Camere Cluj</title>
...
<div class="oferta-container">
    <h2>Apartament 2 Camere Cluj</h2>
    <p class="text-muted">Locuință spațioasă, aproape de centrul vechi și atracțiile turistice.</p>

    <div class="oferta-images">
        <img src="../public/img/oferta2/img1.jpg" alt="Living spațios">
        <img src="../public/img/oferta2/img2.jpg" alt="Dormitor elegant">
        <img src="../public/img/oferta2/img3.jpg" alt="Bucătărie modernă">
    </div>

    <div class="map-container">
        <iframe src="https://www.google.com/maps?q=Cluj-Napoca%20Centru&output=embed" allowfullscreen="" loading="lazy"></iframe>
    </div>
</div>
